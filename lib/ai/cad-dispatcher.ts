...
function commandToThreeObject(
    ...
    switch (cmd.action) {
        case "create_wall": {
            ...
            const color = cmd.params.material ? materialColors[cmd.params.material.toLowerCase()] || "#404040" : "#404040";
        ...
        case "create_slab": {
            ...
            const color = cmd.params.label ? labelColors[cmd.params.label.toLowerCase()] || "#8a8a8a" : "#8a8a8a";
 ...
 * Does NOT dispatch to the store; returns the objects for preview/commit.
 */
