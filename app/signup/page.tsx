  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.username && formData.email && formData.password) {
      ...
      if (typeof window !== "undefined") {
        ...
        localStorage.setItem("drawmatrix_display_name", formData.username);
      }
    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-900 via-blue-600 to-cyan-400">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-white">Join Draw Matrix</h2>
          <p className="text-blue-100 mt-2">Start designing the future.</p>
        </div>
