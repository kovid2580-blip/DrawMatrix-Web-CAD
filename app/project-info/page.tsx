    ...
    const features = [
        {
            ...
            description: "Harness the power of parametric modeling. Design complex structures with real-time feedback and intelligent constraints.",
        },
        {
            icon: <Layout className="w-8 h-8 text-blue-400" />,
            title: "2D Drafting Precision",
            description: "Seamlessly transition between 3D visualization and precise 2D drafting for technical blueprints and floor plans.",
        },
        {
            icon: <Users className="w-8 h-8 text-purple-400" />,
            title: "Real-Time Collaboration",
            description: "Work together on a single project. See your team's cursors and changes instantly across the network.",
        },
        {
            icon: <Zap className="w-8 h-8 text-yellow-500" />,
            title: "Zero-Latency Performance",
            description: "Built for speed. Enjoy 60fps performance even with complex architectural designs and high-poly models.",
        }
    ];
            ...
            <main className="relative z-10 w-full max-w-5xl px-6 py-20 flex flex-col items-center">
                ...
                >
                    <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-1.5 rounded-full border border-white/20 mb-6">
                        ...
                        <span className="text-xs font-bold uppercase tracking-widest text-blue-100">Project Overview</span>
                    </div>
                    <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-6 leading-none">
                        Welcome to <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-cyan-200">Draw Matrix Studio</span>
                    </h1>
                    <p className="text-lg md:text-xl text-blue-100/70 max-w-2xl mx-auto leading-relaxed">
                        The next generation of collaborative architectural design. Experience the future of drafting where precision meets real-time creativity.
                    </p>
                </motion.div>
