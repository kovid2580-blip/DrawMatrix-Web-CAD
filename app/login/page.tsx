          ...
          <div className="space-y-6">
            {status === "loading" ? (
              <div className="flex flex-col items-center gap-4 py-4">
                ...
                <span className="text-white/40 text-[10px] uppercase tracking-[0.2em] font-bold">Initializing Session</span>
              </div>
            ) : (
              <>
                <button 
                  onClick={handleLogin}
                  className="w-full group relative flex items-center justify-center gap-3 bg-white text-gray-900 px-8 py-5 rounded-2xl font-bold text-lg hover:bg-cyan-50 transition-all shadow-xl hover:shadow-cyan-400/20 active:scale-[0.98]"
                >
