...
export default function ProjectsPage() {
    ...
    useEffect(() => {
        ...
        if (saved) {
            setProjects(JSON.parse(saved).sort((a: any, b: any) =>
        ...
        <div className="min-h-screen bg-slate-950 text-white p-8">
            ...
            <div className="max-w-4xl mx-auto py-10">
                <div className="flex items-center gap-6 mb-12">
                    ...
                    <div>
                        <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400">Saved Projects</h1>
                        <p className="text-slate-400 mt-1">Manage and access your historical architectural drawings.</p>
                    </div>
                </div>
                ...
                {projects.length === 0 ? (
                    <div className="py-20 text-center border border-dashed border-white/10 rounded-3xl bg-white/[0.02]">
                        ...
                        <p className="text-slate-500">No saved projects found. Start drawing to see them here.</p>
                        <button
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {projects.map((p) => (
                            ...
                            >
                                ...
                                <div className="text-xs text-orange-400 font-bold uppercase tracking-widest mb-2 opacity-70">.dmx Drawing</div>
                                <div className="text-xl font-bold text-white group-hover:text-orange-100 transition-colors uppercase truncate pr-8">{p.name}</div>
