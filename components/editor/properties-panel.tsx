...
export const PropertiesPanel = () => {
  const { objects, selectedObjectId, updateObject, deleteObject } =
    useThreeStore();
  ...
  return (
    <div className="w-64 bg-[#1e1f22] border-l border-black p-4 text-gray-200 text-xs flex flex-col overflow-y-auto">
      <div className="flex items-center justify-between mb-6 border-b border-gray-800 pb-2">
        <h3 className="font-bold uppercase tracking-widest text-cyan-500">
          Properties
        </h3>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2 pt-2 border-t border-gray-800">
          <span className="text-gray-500 uppercase text-[9px] font-bold italic">
            Geometry
          </span>
