...
import { generateObjects } from "@/lib/ai/cad-dispatcher";
    ...
    const executePrompt = useCallback(
        async (mode: "generate" | "preview") => {
            ...
            try {
                ...
                const objects = generateObjects(drawCommands, activeLayerId);
                ...
                setWarnings(["Failed to process prompt. Please try a different description."]);
            } finally {
                setProcessing(false);
            }
        },
        [currentPrompt, isProcessing, activeLayerId, addObject, pushHistory, setProcessing, setParsedResult, setDrawCommands, setPreviewObjects, addToHistory, addToConversation, clearPreview, setPrompt]
    );
